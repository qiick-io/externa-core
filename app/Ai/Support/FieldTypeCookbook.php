...
final class FieldTypeCookbook
{
    ...
    private static function purpose(FieldTypeEnum $type): string
    {
        return match ($type) {
            ...
            FieldTypeEnum::Files => 'Single or multiple file ids (allow_multiple, default true).',
    ...
    private static function requiredSettingsKeys(FieldTypeEnum $type): array
    {
        return match ($type) {
            ...
            FieldTypeEnum::ManyToMany => ['related_collection_id'],
    ...
    private static function valueShape(FieldTypeEnum $type): string
    {
        return match ($type) {
            ...
            FieldTypeEnum::Files => 'int or int[] (file ids) depending on allow_multiple (default multi)',
            ...
            FieldTypeEnum::ManyToOne => 'int (related item id)',
            FieldTypeEnum::OneToMany => 'int[] (related item ids)',
